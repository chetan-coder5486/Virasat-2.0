...
export const UploadMemoryModal = ({ onClose, circleId = null, onSubmit }) => {
  ...
  useEffect(() => {
    return () => {
      cleanupPreviews(mediaRef.current);
    };
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    if (errors.title || errors.story || errors.date) {
      return;
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <Button
                  type="submit"
                  disabled={
                    uploading || errors.title || errors.story || errors.date
                  }
                  ...
                  {uploadedMedia.map((media, index) => (
                    ...
                    >
                      <button
                        ...
                        className="absolute right-2 top-2 z-10 rounded-full bg-black/70 p-1 text-white opacity-100"
                      >
                        <X className="h-4 w-4" />
                      </button>
